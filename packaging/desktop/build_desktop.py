...
IGNORED_SHELL_ITEMS = {"node_modules", "runtime", "target", ".DS_Store"}
    ...
    *,
    ...
    try:
        ...
        metadata = {
            ...
            "artifacts": [path.name for path in emitted],
...
def main() -> None:
    ...
    try:
        ...
        artifacts = build_desktop(target, runtime, output, keep_stage=args.keep_stage)

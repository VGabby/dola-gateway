...
- `runtime/` contains only a non-distributable placeholder in source. Release
...
`packaging/desktop/build_desktop.py`; it rejects the placeholder and test
fixtures. See `packaging/README.md` for the complete release workflow.
